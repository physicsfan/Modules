!======================================================================
!>This module stores all the root-mean square radii (rrms) of atomic 
!! nuclei that were tabulated by (Angeli et al.)
...
!======================================================================
!> This function returns the source of the value for the given  charge Z and
!! mass A, namely "a" for Angeli et al and "d" otherwise.
